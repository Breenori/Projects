...
public:
	...
	// Prints all members of the list in reverse order to the specified stream <out>
...
private:
	...
	std::ostream& print_reverse_helper(node_t* const& node, std::ostream& out = std::cout) const;
};
