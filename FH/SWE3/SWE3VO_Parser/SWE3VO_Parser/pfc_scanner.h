//       $Id: scanner.h 41752 2020-11-22 12:25:09Z p20068 $
//      $URL: https://svn01.fh-hagenberg.at/bin/cepheiden/pfc/trunk/pfc/inc/pfc/scanner.h $
// $Revision: 41752 $
//     $Date: 2020-11-22 13:25:09 +0100 (So., 22 Nov 2020) $
//   $Author: p20068 $
...
#define PFC_SCANNER_VERSION "2.5.1"
...
// ------------------------------
   ...
   constexpr bool is_keyword (std::size_t const num) const noexcept {
...
// ------------------------------
      ...
      std::size_t register_keyword (std::string const & name) noexcept {
         auto kind {scn::details::sk_keywd};

         kind.num = std::size (m_keywords) + 1;
//       kind.str = name;
...
// ------------------------------
      ...
      std::size_t keyword_is_registered (std::string const & name) const noexcept {
