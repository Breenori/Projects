...
public:
	...
	// Returns the value at index n per reference.
	value_t& at(size_t n);
	...
	void sort();
	// Makes the slist a copy of the other list
	void copy_from(slist const& rhs);
	// Initializes the list with values from 1 to n.
